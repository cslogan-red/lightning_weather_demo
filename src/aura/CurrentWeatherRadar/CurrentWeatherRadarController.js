({
    ...
    initComponent : function( cmp, evt, hlp) {
        ...
        hlp.setVisibility( cmp, evt, hlp, 'main_data_radar', 'HIDE');
        hlp.setVisibility( cmp, evt, hlp, 'loading_spinner_radar', 'SHOW');
        ...
        action.setCallback( this, function( response) {
            ...
            if ( state === 'SUCCESS') {
                ...
                if ( respObj.currentLocation === 'NO_DATA') {
                	...
                	hlp.setVisibility( cmp, evt, hlp, 'loading_spinner_radar', 'HIDE');
                } else {
    ...
    loadingDone : function( cmp, evt, hlp) {
        ...
        hlp.setVisibility( cmp, evt, hlp, 'loading_spinner_radar', 'HIDE');
        hlp.setVisibility( cmp, evt, hlp, 'main_data_radar', 'SHOW');
    },
